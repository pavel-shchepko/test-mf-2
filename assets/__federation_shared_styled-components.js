...
var Fe = new Te(), Me = Ve(), $e = o.createContext({ shouldForwardProp: void 0, styleSheet: Fe, stylis: Me }), ze = $e.Consumer, Be = o.createContext(void 0);
function Le() {
  return c($e);
}
function Ge(e2) {
  var t2 = s(e2.stylisPlugins), n2 = t2[0], r2 = t2[1], c2 = Le().styleSheet, l2 = i(function() {
    var t3 = c2;
  ...
  return o.createElement($e.Provider, { value: d2 }, o.createElement(Be.Provider, { value: u2 }, e2.children));
}
var Ye = function() {
  function e2(e3, t2) {
    var n2 = this;
...
}(), Qe = o.createContext(void 0), et = Qe.Consumer;
function tt() {
  var e2 = c(Qe);
  if (!e2)
    throw he(18);
...
function nt(e2) {
  var n2 = o.useContext(Qe), r2 = i(function() {
  ...
  return e2.children ? o.createElement(Qe.Provider, { value: r2 }, e2.children) : null;
}
var ot = {};
function st(e2, r2, s2) {
  ...
  function O2(e3, r3) {
    return function(e4, r4, s3) {
      var i3 = e4.attrs, a3 = e4.componentStyle, c3 = e4.defaultProps, p3 = e4.foldedComponentIds, d3 = e4.styledComponentId, h3 = e4.target, f3 = o.useContext(Qe), m3 = Le(), y3 = e4.shouldForwardProp || m3.shouldForwardProp;
...
var dt = function() {
  ...
  return e2.prototype.createStyles = function(e3, t2, n2, o2) {
    ...
    e3 > 2 && Te.registerId(this.componentId + e3), this.removeStyles(e3, n2), this.createStyles(e3, t2, n2, o2);
  }, e2;
}();
function ht(n2) {
  for (var r2 = [], s2 = 1; s2 < arguments.length; s2++)
    r2[s2 - 1] = arguments[s2];
  var i2 = ct.apply(void 0, __spreadArray([n2], r2, false)), a2 = "sc-global-".concat(z(JSON.stringify(i2))), c2 = new dt(i2, a2);
  var l2 = function(e2) {
    var t2 = Le(), n3 = o.useContext(Qe), r3 = o.useRef(t2.styleSheet.allocateGSInstance(a2)).current;
...
function ft(t2) {
  for (var n2 = [], o2 = 1; o2 < arguments.length; o2++)
    n2[o2 - 1] = arguments[o2];
  var r2 = ae(ct.apply(void 0, __spreadArray([t2], n2, false))), s2 = z(r2);
  return new Ye(s2, r2);
}
function mt(e2) {
  var n2 = o.forwardRef(function(n3, r2) {
    var s2 = I(n3, o.useContext(Qe), e2.defaultProps);
...
var yt = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t2 = e3.instance.toString(), n2 = _e(), o2 = ae([n2 && 'nonce="'.concat(n2, '"'), "".concat(f, '="true"'), "".concat(y, '="').concat(v, '"')].filter(Boolean), " ");
      ...
      if (e3.sealed)
        throw he(2);
      var r2 = ((n2 = {})[f] = "", n2[y] = v, n2.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, n2), s2 = _e();
      return s2 && (r2.nonce = s2), [o.createElement("style", __assign({}, r2, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e3.sealed = true;
